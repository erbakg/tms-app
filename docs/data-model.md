...
- **Load** — корень агрегата: номер и контакты брокера, груз, equipment, операционные и финансовые условия, внутренние комментарии, жизненный цикл, внутренний идентификатор и назначенный водитель. Ставка и billing/factoring данные сохраняются отдельно от driver view.
...
- **LoadFieldVisibility** — настройка видимости каждого разрешённого операционного поля водителю для конкретного Load. По умолчанию поле закрыто; финансовые и внутренние поля не входят в список разрешённых полей.
