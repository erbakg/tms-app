# 312 KG TMS — Engineering Documentation

This folder documents decisions that affect implementation, operations, and the team workflow. Documentation is versioned with the code: a change to the system should update the relevant Markdown page in the same pull request.
