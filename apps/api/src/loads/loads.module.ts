...
import { DriverLoadsController } from './http/driver-loads.controller.js';
...
@Module({
  ...
  controllers: [LoadsController, StopsController, DocumentsController, DriverLoadsController],
  providers: [
    LoadService,
    RateConfirmationIntakeService,
    StopService,
    DocumentService,
    {
