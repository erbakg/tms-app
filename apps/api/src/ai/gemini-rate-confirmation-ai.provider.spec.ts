...
const validOutput = {
  ...
  brokerContactName: { value: null, confidence: 'NOT_FOUND' },
  brokerContactPhone: { value: null, confidence: 'NOT_FOUND' },
  brokerContactEmail: { value: null, confidence: 'NOT_FOUND' },
  ...
  pieces: { value: null, confidence: 'NOT_FOUND' },
  equipmentType: { value: null, confidence: 'NOT_FOUND' },
  temperatureRequirements: { value: null, confidence: 'NOT_FOUND' },
  specialInstructions: { value: null, confidence: 'NOT_FOUND' },
  detentionTerms: { value: null, confidence: 'NOT_FOUND' },
  layoverTerms: { value: null, confidence: 'NOT_FOUND' },
  tonuTerms: { value: null, confidence: 'NOT_FOUND' },
  lumperInstructions: { value: null, confidence: 'NOT_FOUND' },
  trackingRequirements: { value: null, confidence: 'NOT_FOUND' },
  podRequirements: { value: null, confidence: 'NOT_FOUND' },
  invoicingInstructions: { value: null, confidence: 'NOT_FOUND' },
  billingEmail: { value: null, confidence: 'NOT_FOUND' },
  billingAddress: { value: null, confidence: 'NOT_FOUND' },
  factoringInformation: { value: null, confidence: 'NOT_FOUND' },
  requiredDocuments: { value: null, confidence: 'NOT_FOUND' },
  notes: { value: null, confidence: 'NOT_FOUND' },
  stops: [],
};
